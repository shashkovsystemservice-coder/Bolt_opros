        ...
        description: string;
          canonical_blueprint: any;
            ...
            interface StandardsCatalogModalProps {
              isOpen: boolean;
                onClose: () => void;
                  onSelectStandard: (standard: StandardTemplate) => void;
                  }
                                                                                                                                                                                              ...
                                                                                                                                                                                              {loading ? (
                                                                                                                                                                                                        <div className="flex justify-center items-center h-64">
                                                                                                                                                                                                                    <p>Загрузка...</p>
                                                                                                                                                                                                                                                 ...
                                                                                                                                                                                                                                                 <div className="flex justify-center items-center h-64">
                                                                                                                                                                                                                                                             <p className="text-gray-500">Методики не найдены</p>
                                                                                                                                                                                                                                                                       </div>
                                                                                                                                                                                                                                                                               ) : (
                                                                                                                                                                                                                                                                                                                                   ...
                                                                                                                                                                                                                                                                                                                                   <h3 className="font-bold text-lg mb-2">{standard.name}</h3>
                                                                                                                                                                                                                                                                                                                                                   <p className="text-sm text-gray-500 mb-2">{standard.category}</p>
                                                                                                                                                                                                                                                                                                                                                                   <p className="text-sm flex-grow">{standard.description}</p>
                                                                                                                                                                                                                                                                                                                                                                                   <Button onClick={() => onSelectStandard(standard)} className="mt-4 w-full">
                                                                                                                                                                                                                                                                                                                                                                                                     Применить методику
                                                                                                                                                                                                                                                                                                                                                                                                                     </Button>
                                                                                                                                                                                                                                                                                                                                                                                                                                   </div>
                                                                                                                                                                                                                                                                                                                                                                                                                                               ))}
